		...
		>
			<div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full text-lg">
				...
				<p className="mb-4 py-6">
					I'am a Frontend Developer with an interest in web and mobile
					development. Proficient in developing using JavaScript, React Js, Vue
					Js, or other frameworks to create appealing and responsive user
					interfaces. Always keeping up with the latest trends in the web
					industry to deliver an excellent user experience. Committed to
					collaborating with design teams, optimizing performance, and
					delivering innovative technical solutions.
				</p>

				<p>
					Thanks to my creativity, my attention to detail and my determination,
					I realized that I have a great talent for developing web and mobile
					applications. I am fascinated by this great world of technologies and
					possibilities, and I am sure that I will be able to create incredible
					projects both professionally and personally with you.
				</p>
